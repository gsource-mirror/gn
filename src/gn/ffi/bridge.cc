...
#ifndef CXXBRIDGE1_STRUCT_ScopePair
#define CXXBRIDGE1_STRUCT_ScopePair
struct ScopePair final {
  ::rust::Str key;
  ::Value const& value;

  using IsRelocatable = ::std::true_type;
};
#endif  // CXXBRIDGE1_STRUCT_ScopePair
...
void cxxbridge1$196$NewScope(::Scope const& parent_scope,
                             ::rust::Slice<::rust::Str const> keys,
                             ::std::unique_ptr<::Scope>& out_scope,
                             ::SliceAny* return$) noexcept {
  ::SliceAny (*NewScope$)(::Scope const&, ::rust::Slice<::rust::Str const>,
                          ::std::unique_ptr<::Scope>&) = ::NewScope;
  new (return$)::SliceAny(NewScope$(parent_scope, keys, out_scope));
}

void cxxbridge1$196$GetScopeItems(::Scope const& scope,
                                  ::SliceAny* return$) noexcept {
...
::std::uint8_t cxxbridge1$196$type_cxx(::Value const& val) noexcept {
  ::std::uint8_t (*type_cxx$)(::Value const&) = ::GetValueType;
  return type_cxx$(val);
}

void cxxbridge1$196$Value$boolean_value(::Value const& self,
                                        bool const** return$) noexcept {
  bool const& (::Value::*boolean_value$)() const = &::Value::boolean_value;
  new (return$) bool const*(&(self.*boolean_value$)());
}

void cxxbridge1$196$Value$int_value(::Value const& self,
                                    ::std::int64_t const** return$) noexcept {
  ::std::int64_t const& (::Value::*int_value$)() const = &::Value::int_value;
  new (return$)::std::int64_t const*(&(self.*int_value$)());
}

void cxxbridge1$196$Value$string_value(::Value const& self,
                                       ::std::string const** return$) noexcept {
  ::std::string const& (::Value::*string_value$)() const =
      &::Value::string_value;
  new (return$)::std::string const*(&(self.*string_value$)());
}

void cxxbridge1$196$list_value_cxx(::Value const& val,
                                   ::SliceAny* return$) noexcept {
...
void cxxbridge1$196$SetValueNone(::Value& val,
                                 ::ParseNode const* origin) noexcept {
  void (*SetValueNone$)(::Value&, ::ParseNode const*) = ::SetValueNone;
  SetValueNone$(val, origin);
}

void cxxbridge1$196$SetValueBool(::Value& val,
                                 ::ParseNode const* origin,
                                 bool b) noexcept {
  void (*SetValueBool$)(::Value&, ::ParseNode const*, bool) = ::SetValueBool;
  SetValueBool$(val, origin, b);
}

void cxxbridge1$196$SetValueInt(::Value& val,
                                ::ParseNode const* origin,
                                ::std::int64_t i) noexcept {
  void (*SetValueInt$)(::Value&, ::ParseNode const*, ::std::int64_t) =
      ::SetValueInt;
  SetValueInt$(val, origin, i);
}

void cxxbridge1$196$SetValueString(::Value& val,
                                   ::ParseNode const* origin,
                                   ::rust::Str s) noexcept {
  void (*SetValueString$)(::Value&, ::ParseNode const*, ::rust::Str) =
      ::SetValueString;
  SetValueString$(val, origin, s);
}

::std::uint8_t* cxxbridge1$196$SetValueList(::Value& val,
                                            ::ParseNode const* origin,
                                            ::std::size_t size) noexcept {
  ::std::uint8_t* (*SetValueList$)(::Value&, ::ParseNode const*,
                                   ::std::size_t) = ::SetValueList;
  return SetValueList$(val, origin, size);
}

void cxxbridge1$196$SetValueScope(::Value& val,
                                  ::ParseNode const* origin,
                                  ::Scope* scope) noexcept {
  void (*SetValueScope$)(::Value&, ::ParseNode const*,
                         ::std::unique_ptr<::Scope>) = ::SetValueScope;
  SetValueScope$(val, origin, ::std::unique_ptr<::Scope>(scope));
}

static_assert(
    ::rust::detail::is_complete<::std::remove_extent<::Scope>::type>::value,
    "definition of `::Scope` is required");
static_assert(sizeof(::std::unique_ptr<::Scope>) == sizeof(void*), "");
static_assert(alignof(::std::unique_ptr<::Scope>) == alignof(void*), "");
void cxxbridge1$unique_ptr$Scope$null(
    ::std::unique_ptr<::Scope>* ptr) noexcept {
  ::new (ptr)::std::unique_ptr<::Scope>();
}
void cxxbridge1$unique_ptr$Scope$raw(
    ::std::unique_ptr<::Scope>* ptr,
    ::std::unique_ptr<::Scope>::pointer raw) noexcept {
  ::new (ptr)::std::unique_ptr<::Scope>(raw);
}
::std::unique_ptr<::Scope>::element_type const* cxxbridge1$unique_ptr$Scope$get(
    ::std::unique_ptr<::Scope> const& ptr) noexcept {
  return ptr.get();
}
::std::unique_ptr<::Scope>::pointer cxxbridge1$unique_ptr$Scope$release(
    ::std::unique_ptr<::Scope>& ptr) noexcept {
  return ptr.release();
}
void cxxbridge1$unique_ptr$Scope$drop(
    ::std::unique_ptr<::Scope>* ptr) noexcept {
...
static_assert(
    ::rust::detail::is_complete<::std::remove_extent<::Value>::type>::value,
...
void cxxbridge1$unique_ptr$Value$null(
    ::std::unique_ptr<::Value>* ptr) noexcept {
  ::new (ptr)::std::unique_ptr<::Value>();
}
void cxxbridge1$unique_ptr$Value$raw(
    ::std::unique_ptr<::Value>* ptr,
    ::std::unique_ptr<::Value>::pointer raw) noexcept {
  ::new (ptr)::std::unique_ptr<::Value>(raw);
}
::std::unique_ptr<::Value>::element_type const* cxxbridge1$unique_ptr$Value$get(
    ::std::unique_ptr<::Value> const& ptr) noexcept {
  return ptr.get();
}
::std::unique_ptr<::Value>::pointer cxxbridge1$unique_ptr$Value$release(
    ::std::unique_ptr<::Value>& ptr) noexcept {
  return ptr.release();
}
void cxxbridge1$unique_ptr$Value$drop(
    ::std::unique_ptr<::Value>* ptr) noexcept {
