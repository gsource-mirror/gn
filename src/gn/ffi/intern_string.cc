...
// to prevent link-time dependencies on the `ctx` crate for standalone cargo unit tests.
//
// By isolating `intern_string` in its own object file (`intern_string.o`), the linker only
// pulls in this file and does not pull in `cxx_api.o`.
