...
class Target : public Item {
 ...
 private:
  ...
  //    return a dangling pointer to freed TargetInfo from the previous
  //    instance.
  ...
  //      the corresponding 'resolved_target_data_info_' pointer is guaranteed
  //      to be visible, valid, and owned by this instance.
