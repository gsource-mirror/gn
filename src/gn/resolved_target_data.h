...
class ResolvedTargetData {
 ...
 private:
  ...
  // 64 shards is chosen as a sweet spot between reducing contention for typical
  // high-core workstation counts (32-64 threads) and keeping minimal memory overhead
  // from empty shards.
