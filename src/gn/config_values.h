...
#undef DIR_VALUES_ACCESSOR
  ...
  const std::vector<SubstitutionPattern>& additional_outputs() const {
    return additional_outputs_;
  }
  std::vector<SubstitutionPattern>& additional_outputs() {
    return additional_outputs_;
  }
 ...
 private:
  ...
  std::vector<SubstitutionPattern> additional_outputs_;
