...
impl SourceDir {
    pub fn as_rust(&self) -> &types::PackageRef {
        ...
        // While source dirs aren't guarunteed to start with "//" (they may be absolute),
        // we only convert source dirs to rust for either labels or BUILD.gn directories,
        // both of which are guarunteed to be source-relative.
