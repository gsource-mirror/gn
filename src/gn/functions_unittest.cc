...
def make_list_with_kwargs(a, b="default"):
  ...
  // 1. Parse and execute the whole block in a single script.
  TestParseInput input(R"gn(
    load("//:rules.bzl", "add", "make_list", "make_list_with_kwargs")
    result_add = add(40, 2)
    result_list = make_list(10, "hello")
