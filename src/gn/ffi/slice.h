...
// required to support both mutable and immutable slices in Rust). The Rust side
// is responsible for guarunteeing that if the underlying vector is const,
// the returned slice is used immutably.
template <typename T>
