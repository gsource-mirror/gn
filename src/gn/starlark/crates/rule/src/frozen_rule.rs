...
use starlark::{
    ...
    values::{FrozenHeap, FrozenValue, FrozenValueTyped, StarlarkValue, Value},
};
use starlark_derive::{starlark_value, NoSerialize};
use types::{EvalContext, EvaluatorContextExt, Scope};
...
impl<C: EvalContext + EvalContextAttrExt> FrozenRule<C> {
    ...
    pub fn new_builtin(builtin: OutputType, frozen_heap: &FrozenHeap) -> Self {
        ...
        Self {
            ...
            once_named: Some((name.to_owned(), signature)),
            parent: None,
    ...
    Self: ProvidesStaticType<'v>,
{
    ...
    fn invoke(
        ...
        let (_name, signature) = self
            .once_named
            .as_ref()
            .ok_or_else(|| starlark::Error::new_other(crate::Error::RuleMustBeNamed))?;
