...
// relative to the output directory. Always null-terminated.
class OutputFile {
 public:
  OutputFile() = default;

  explicit OutputFile(std::string_view v) {
 ...
 private:
  ...
  //   fact even be an improvement, as OutputFiles are almost universally very long.
