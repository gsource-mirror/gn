...
TEST_F(NinjaCBinaryTargetWriterTest, SourceSet) {
...

  {
    ...
    const char expected[] =
        ...
        "../../foo/input3.o ../../foo/input4.obj || phony/foo/bar.linkdeps\n"
        "  ldflags =\n"
        "  libs =\n"
        "  frameworks =\n"
        "  swiftmodules =\n"
...
TEST_F(NinjaCBinaryTargetWriterTest, NoHardDepsToNoPublicHeaderTarget) {
  ...
  const char obj_expected[] =
      ...
      "obj/BUILD_DIR/gen_obj.generated.o || phony/foo/generate\n"
...
TEST_F(NinjaCBinaryTargetWriterTest, FrameworksAndFrameworkDirs) {
  ...
  const char expected[] =
      ...
      "  ldflags = -F.\n"
      "  libs =\n"
      "  frameworks = -framework System -framework Bar -weak_framework "
      "Whizbang\n"
      "  swiftmodules =\n"
      "  output_extension = .so\n"
      "  output_dir =\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, WinPrecompiledHeaders) {
  ...
  // This target doesn't specify precompiled headers.
  {
    ...
    const char no_pch_expected[] =
        ...
        "\n"
        "build withpch/obj/foo/no_pch_target.input1.o: withpch_cxx "
        "../../foo/input1.cc\n"
        "  source_file_part = input1.cc\n"
        "  source_name_part = input1\n"
        "build withpch/obj/foo/no_pch_target.input2.o: withpch_cc "
        "../../foo/input2.c\n"
        "  source_file_part = input2.c\n"
        "  source_name_part = input2\n"
        "build withpch/phony/foo/no_pch_target.linkdeps: phony "
        "withpch/obj/foo/no_pch_target.input1.o "
        "withpch/obj/foo/no_pch_target.input2.o\n"
        "build withpch/phony/foo/no_pch_target: phony "
        "withpch/phony/foo/no_pch_target.linkdeps\n";
  ...
  // This target specifies PCH.
  {
    ...
    const char pch_win_expected[] =
        ...
        "\n"
        "build withpch/obj/build/pch_target.precompile.c.o: withpch_cc "
        "../../build/precompile.cc\n"
        "  source_file_part = precompile.cc\n"
        "  source_name_part = precompile\n"
        "  cflags_c = ${cflags_c} /Ycbuild/precompile.h\n"
        "build withpch/obj/build/pch_target.precompile.cc.o: withpch_cxx "
        "../../build/precompile.cc\n"
        "  source_file_part = precompile.cc\n"
        "  source_name_part = precompile\n"
        "  cflags_cc = ${cflags_cc} /Ycbuild/precompile.h\n"
        "build withpch/obj/foo/pch_target.input1.o: withpch_cxx "
        "../../foo/input1.cc | withpch/obj/build/pch_target.precompile.cc.o\n"
        "  source_file_part = input1.cc\n"
        "  source_name_part = input1\n"
        "build withpch/obj/foo/pch_target.input2.o: withpch_cc "
        "../../foo/input2.c | withpch/obj/build/pch_target.precompile.c.o\n"
        "  source_file_part = input2.c\n"
        "  source_name_part = input2\n"
...
TEST_F(NinjaCBinaryTargetWriterTest, GCCPrecompiledHeaders) {
  ...
  // This target specifies PCH.
  {
    ...
    const char pch_gcc_expected[] =
        ...
        "include_dirs =\n"
        "cflags =\n"
        "cflags_c = -std=c99 -include "
        "withpch/obj/build/pch_target.precompile.h-c\n"
        "cflags_cc = -include withpch/obj/build/pch_target.precompile.h-cc\n"
        "target_output_name = pch_target\n"
        "\n"
        "build withpch/obj/build/pch_target.precompile.h-c.gch: withpch_cc "
        "../../build/precompile.h\n"
        "  source_file_part = precompile.h\n"
        "  source_name_part = precompile\n"
        "  cflags_c = -std=c99 -x c-header\n"
        "build withpch/obj/build/pch_target.precompile.h-cc.gch: withpch_cxx "
        "../../build/precompile.h\n"
        "  source_file_part = precompile.h\n"
        "  source_name_part = precompile\n"
        ...
        "  source_name_part = input1\n"
        "build withpch/obj/foo/pch_target.input2.o: withpch_cc "
        "../../foo/input2.c | withpch/obj/build/pch_target.precompile.h-c.gch\n"
        "  source_file_part = input2.c\n"
        "  source_name_part = input2\n"
        "build withpch/phony/foo/pch_target.linkdeps: phony "
        "withpch/obj/foo/pch_target.input1.o "
...
TEST_F(NinjaCBinaryTargetWriterTest, InputFiles) {
  ...
  // This target has multiple inputs.
  {
    ...
    const char expected[] =
        ...
        "target_output_name = bar\n"
        "\n"
        "build phony/foo/bar.inputs: phony ../../foo/input1.data "
        "../../foo/input2.data\n"
        "build obj/foo/bar.input1.o: cxx ../../foo/input1.cc | "
  ...
  // from a config tacked on to said config.
  {
    ...
    const char expected[] =
        ...
        "\n"
        "build phony/foo/bar.inputs: phony ../../foo/input1.data "
        "../../foo/input2.data ../../foo/input3.data\n"
        "build obj/foo/bar.input1.o: cxx ../../foo/input1.cc | "
        "phony/foo/bar.inputs\n"
        "  source_file_part = input1.cc\n"
        "  source_name_part = input1\n"
...
TEST_F(NinjaCBinaryTargetWriterTest, RlibsWithProcMacros) {
  ...
  const char expected[] =
      ...
      "  source_file_part = main.cc\n"
      "  source_name_part = main\n"
      "build ./exe: link obj/exe/exe.main.o obj/staticlib/libstaticlib.a | "
      "obj/pub_in_staticlib/libpub_in_staticlib.rlib "
      "obj/priv_in_staticlib/libpriv_in_staticlib.rlib obj/rlib/librlib.rlib "
...
TEST_F(NinjaCBinaryTargetWriterTest, LinkingWithRustLibraryDepsOnCdylib) {
  ...
  const char expected[] =
      ...
      "./libcc_shlib.so | obj/rlib/librlib.rlib\n"
      "  ldflags =\n"
      "  libs =\n"
      "  frameworks =\n"
      "  swiftmodules =\n"
...
TEST_F(NinjaCBinaryTargetWriterTest, RustLibAfterSharedLib) {
  ...
  const char expected[] =
      ...
      "  source_file_part = main.cc\n"
      "  source_name_part = main\n"
      "build ./binary: link obj/exe/binary.main.o ./mysharedlib1.so "
      "./mysharedlib3.so obj/static2/libstaticlib2.a | "
      "obj/rlib2/libmyrlib2.rlib\n"
      "  ldflags =\n"
      "  libs =\n"
      "  frameworks =\n"
      "  swiftmodules =\n"
...
TEST_F(NinjaCBinaryTargetWriterTest, DependOnModule) {
  ...
  // The library first.
  {
    ...
    const char expected[] =
        ...
        "module_deps = -fmodule-map-file=../../blah/a.modulemap "
        "-fmodule-file=blah_a=obj/blah/liba.a.pcm\n"
  ...
  // A second library to make sure the depender includes both.
  {
    ...
    const char expected[] =
        ...
        "module_deps = -fmodule-map-file=../../stuff/b.modulemap "
        "-fmodule-file=//stuff:b(//toolchain:default)=obj/stuff/libb.b.pcm "
        "-fmodule-map-file=../../blah/a.modulemap "
        "-fmodule-file=blah_a=obj/blah/liba.a.pcm\n"
        "module_deps_no_self = -fmodule-map-file=../../stuff/b.modulemap "
        "-fmodule-map-file=../../blah/a.modulemap "
        "-fmodule-file=blah_a=obj/blah/liba.a.pcm\n"
        "root_out_dir = withmodules\n"
  ...
  // check module_deps_no_self.
  {
    ...
    const char expected[] =
        ...
        "module_deps = -fmodule-map-file=../../stuff/b.modulemap "
        "-fmodule-file=//stuff:b(//toolchain:default)=obj/stuff/libb.b.pcm "
        "-fmodule-map-file=../../stuff/c.modulemap "
        "-fmodule-file=//things:c=obj/stuff/libc.c.pcm "
        "-fmodule-map-file=../../blah/a.modulemap "
        "-fmodule-file=blah_a=obj/blah/liba.a.pcm\n"
        "module_deps_no_self = -fmodule-map-file=../../stuff/b.modulemap "
        "-fmodule-file=//stuff:b(//toolchain:default)=obj/stuff/libb.b.pcm "
        ...
        "\n"
        "build obj/stuff/libc.c.pcm: cxx_module ../../stuff/c.modulemap | "
        "obj/stuff/libb.b.pcm obj/blah/liba.a.pcm\n"
  ...
  // Then the executable that depends on it.
  {
    ...
    const char expected[] =
        ...
        "\n"
        "build obj/zap/c.x.o: cxx ../../zap/x.cc | obj/stuff/libb.b.pcm "
        "obj/blah/liba.a.pcm\n"
        "  source_file_part = x.cc\n"
        "  source_name_part = x\n"
        "build obj/zap/c.y.o: cxx ../../zap/y.cc | obj/stuff/libb.b.pcm "
        "obj/blah/liba.a.pcm\n"
        "  source_file_part = y.cc\n"
        "  source_name_part = y\n"
        "build withmodules/c: link obj/zap/c.x.o obj/zap/c.y.o "
        "obj/stuff/libb.a obj/blah/liba.a\n"
        "  ldflags =\n"
        "  libs =\n"
        "  frameworks =\n"
        "  swiftmodules =\n"
