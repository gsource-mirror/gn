...
/// This matches the execution phase where rule implementation is run synchronously.
    ...
    <C::Session as Session>::TargetRef: TargetAttrExt<Rule = FrozenRule<C>>,
{
    ...
    Module::with_temp_heap(|module| {
        ...
        // When the module is frozen, only things transitively required by extra_value are kept.
