...
TEST(NinjaFileTest, FileVariablesAndCustomRules) {
  NinjaFile file;
  file.file_vars.emplace_back("defines", "-DFOO");
  file.file_vars.emplace_back("include_dirs", "");
...
TEST(NinjaFileTest, HoistingSingleTarget) {
  NinjaFile file;
  NinjaTargetGroup group;
  group.target_vars.emplace_back("cflags", "-fPIC");
  group.target_vars.emplace_back("defines", "-DFOO");
...
TEST(NinjaFileTest, HoistingMultipleTargets) {
  ...
  alpha.target_vars.emplace_back("cflags", "-fPIC");
  alpha.target_vars.emplace_back("defines", "-DALPHA");
  ...
  beta.target_vars.emplace_back("cflags", "-fPIC");
  beta.target_vars.emplace_back("defines", "-DBETA");
