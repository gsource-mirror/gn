...
source_set("included") {
  ...
  EXPECT_EQ(
      "Warning: \"//private.h\" is in the private API of //:included\n"
      "[AMBIGUOUS] Suggestion: Choose one of the following to resolve the "
      "intra-target include:\n"
      "* Create a new source_set for \"private.h\" and add it to public_deps "
      "in //:included (preferred)\n"
      "* Move \"private.h\" from `sources` to `public` in :included "
      "(defined at //BUILD.gn:5)\n"
      "  (`gn edit \"move sources public private.h\" //:included`)\n"
      "* Move \"included.h\" from `public` to `sources` in :included "
      "(defined at //BUILD.gn:5)\n"
