...
*   [Variables you set in targets](#target_variables)
    ...
    *   [c_additional_outputs: [string list] Additional outputs for the tool.](#var_c_additional_outputs)
...
```
### <a name="var_c_additional_outputs"></a>**c_additional_outputs**: [string list] Additional outputs for the tool.&nbsp;[Back to Top](#gn-reference)
