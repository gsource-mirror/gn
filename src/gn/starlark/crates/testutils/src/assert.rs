...
/// A simple wrapper around starlark::Assert that provides fake evaluation contexts.
pub struct Assert {
...
impl Assert {
    ...
    pub fn new(context: FakeEvalContext) -> Self {
        ...
        // to check for GC bugs. Because the EvalContext can be mutated by the evaluator,
        // running 3 times could cause state mutations to happen three times, messing with tests.
