...
class Target : public Item {
 public:
  ...
  // Whether this target allows transitive includes from public_deps.
  bool allow_includes_from_public_deps() const {
    return allow_includes_from_public_deps_;
  }
  void set_allow_includes_from_public_deps(bool value) {
    allow_includes_from_public_deps_ = value;
  }
 ...
 private:
  ...
  bool allow_includes_from_public_deps_ = true;
