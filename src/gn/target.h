...
class Target : public Item {
 public:
  ...
  constexpr static auto kModuleMapMissing =
      ModuleType(1 << MODULEMAP_DISALLOWED_NONTEXTUAL_DEP);
  constexpr static auto kSourceModulemap =
      ModuleType((1 << HAS_MODULEMAP) | (1 << MODULEMAP_EXACT));
