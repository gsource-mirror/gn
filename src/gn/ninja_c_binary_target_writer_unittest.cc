...
TEST_F(NinjaCBinaryTargetWriterTest, SourceSet) {
  ...
  // Source set itself.
  {
    ...
    const char expected[] =
        ...
        "\n"
        "build phony/foo/bar.link: phony obj/foo/bar.input1.o "
        "obj/foo/bar.input2.o ../../foo/input3.o ../../foo/input4.obj\n"
        "build phony/foo/bar: phony phony/foo/bar.link\n";
...

  {
    ...
    const char expected[] =
        ...
        "build obj/foo/libstlib.a: alink || phony/foo/bar.link\n"
        "  arflags =\n"
        "  output_extension =\n"
        "  output_dir =\n";
    std::string out_str = out.str();
...
TEST_F(NinjaCBinaryTargetWriterTest, AdditionalOutputs) {
  ...
  const char expected[] =
      ...
      "\n"
        "build phony/foo/bar.link: phony obj/foo/bar.input1.o\n"
        "build phony/foo/bar: phony phony/foo/bar.link obj/foo/input1.dwo\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, SourceSetWithAdditionalOutputsToStaticLib) {
  Err err;
  TestWithScope setup;
  ...
  // Verify B's output
  {
    ...
    const char expected[] =
        ...
        "  source_name_part = b2\n"
        "\n"
        "build phony/foo/b.link: phony obj/foo/b.b.o obj/foo/b.b2.o\n"
        "build phony/foo/b: phony phony/foo/b.link obj/foo/b.dwo obj/foo/b2.dwo\n";
  ...
  // Verify A's output
  {
    ...
    const char expected[] =
        ...
        "  source_name_part = a\n"
        "\n"
        "build obj/foo/liba.a: alink obj/foo/liba.a.o || phony/foo/b.link\n"
        "  arflags =\n"
        "  output_extension =\n"
        "  output_dir =\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, NoHardDepsToNoPublicHeaderTarget) {
  ...
  const char obj_expected[] =
      ...
      "\n"
        "build phony/foo/gen_obj.link: phony obj/BUILD_DIR/gen_obj.generated.o"
        // The order-only dependency here is strictly unnecessary since the
        // sources list this as an order-only dep.
        " || phony/foo/generate\n"
        "build phony/foo/gen_obj: phony phony/foo/gen_obj.link\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, SourceSetDataDeps) {
  ...
  const char inter_expected[] =
      ...
      "\n"
        "build phony/foo/inter.link: phony obj/foo/inter.inter.o || "
        "./data_target\n"
        "build phony/foo/inter: phony phony/foo/inter.link\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, WinPrecompiledHeaders) {
  ...
  // This target specifies PCH.
  {
    ...
    const char pch_win_expected[] =
        ...
        "  source_name_part = input2\n"
        "\n"
        "build withpch/phony/foo/pch_target.link: phony "
        ...
        "withpch/obj/build/pch_target.precompile.c.o "
        "withpch/obj/build/pch_target.precompile.cc.o\n"
        "build withpch/phony/foo/pch_target: phony withpch/phony/foo/pch_target.link\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, GCCPrecompiledHeaders) {
  ...
  // This target specifies PCH.
  {
    ...
    const char pch_gcc_expected[] =
        ...
        "  source_name_part = input2\n"
        "\n"
        "build withpch/phony/foo/pch_target.link: "
        "phony withpch/obj/foo/pch_target.input1.o "
        "withpch/obj/foo/pch_target.input2.o\n"
        "build withpch/phony/foo/pch_target: "
        "phony withpch/phony/foo/pch_target.link\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, RlibInLibrary) {
  ...
  const char expected[] =
      ...
      "phony/pub_sset_in_staticlib/pub_sset_in_staticlib.link "
      "phony/priv_sset_in_staticlib/priv_sset_in_staticlib.link\n"
      "  ldflags =\n"
      "  libs =\n"
      "  frameworks =\n"
      "  swiftmodules =\n"
...
TEST_F(NinjaCBinaryTargetWriterTest, ModuleMapInSourceSet) {
  ...
  const char expected[] =
      ...
      "  source_name_part = bar\n"
      "\n"
      "build phony/foo/bar.link: phony obj/foo/bar.bar.o\n"
      "build phony/foo/bar: phony phony/foo/bar.link obj/foo/bar.bar.pcm\n";
  std::string out_str = out.str();
  EXPECT_EQ(expected, out_str);
}
...
TEST_F(NinjaCBinaryTargetWriterTest, SwiftModule) {
...

  {
    ...
    const char expected[] =
        ...
        "  restat = 1\n"
        "\n"
        "build phony/foo/foo.link: phony obj/foo/file1.o obj/foo/file2.o\n"
        "build phony/foo/foo: phony phony/foo/foo.link gen/foo/foo.h obj/foo/Foo.swiftmodule\n";
  ...
  // Swift module_dirs correctly set if dependency between Swift modules.
  {
    ...
    const char expected[] =
        ...
        "  restat = 1\n"
        "\n"
        "build phony/bar/bar.link: phony obj/bar/bar.o || phony/foo/foo.link\n"
        "build phony/bar/bar: phony phony/bar/bar.link gen/bar/bar.h obj/bar/Bar.swiftmodule\n";
  ...
  // even if the dependency is indirect (via public_deps).
  {
    ...
    const char expected[] =
        ...
        "  restat = 1\n"
        "\n"
        "build phony/bar/bar.link: phony obj/bar/bar.o || phony/bar/group phony/foo/foo.link\n"
        "build phony/bar/bar: phony phony/bar/bar.link gen/bar/bar.h obj/bar/Bar.swiftmodule\n";
...
TEST_F(NinjaCBinaryTargetWriterTest, ModuleMapGeneration) {
  ...
  const char expected_ninja[] =
      ...
      "\n"
      "build phony/foo/bar.link: phony obj/foo/bar.source1.o\n"
      "build phony/foo/bar: phony phony/foo/bar.link\n";
  writer.Run();
  ...
  const char expected_root_ninja[] =
      ...
      "\n"
      "build phony/foo/root.link: phony obj/foo/root.root.o\n"
      "build phony/foo/root: phony phony/foo/root.link\n";
