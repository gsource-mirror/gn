...
void cxxbridge1$196$TestWithScope$scope_cxx(::TestWithScope &self, ::Scope **return$) noexcept {
  ::Scope &(::TestWithScope::*scope_cxx$)() = &::TestWithScope::scope_ref;
  new (return$) ::Scope *(&(self.*scope_cxx$)());
}
