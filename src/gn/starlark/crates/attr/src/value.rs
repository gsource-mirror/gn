...
mod tests {
    ...
    fn test_to_value_label_no_files() {
        ...
        Module::with_temp_heap(|module| {
            ...
            let AttrValue { attr, file, files } =
                Attr::Label(Some(crate::LabelOrFile::Label(target_empty.label().to_owned())))
                    .to_value(
                        &schema,
                        &session,
                        &session.default_toolchain.as_ref(),
            ...
            let AttrValue { files, file, .. } =
                Attr::Label(Some(crate::LabelOrFile::Label(target_outputs.label().to_owned())))
                    .to_value(
                        &schema,
                        &session,
                        &session.default_toolchain.as_ref(),
    ...
    fn test_to_value_label_allow_files_single() {
        ...
        Module::with_temp_heap(|module| {
            ...
            let res_empty = Attr::Label(Some(crate::LabelOrFile::Label(target_empty.label().to_owned())))
                .to_value(
                    &schema,
                    &session,
                    &session.default_toolchain.as_ref(),
    ...
    fn test_to_value_label_allow_files_matching() {
        ...
        Module::with_temp_heap(|module| {
            ...
            // files are collected
            let AttrValue { files, .. } =
                Attr::Label(Some(crate::LabelOrFile::Label(target_matching.label().to_owned())))
                    .to_value(
                        &schema,
                        &session,
                        &session.default_toolchain.as_ref(),
            ...
            let res = Attr::Label(Some(crate::LabelOrFile::Label(target_no_matching.label().to_owned()))).to_value(
                &schema,
                &session,
                &session.default_toolchain.as_ref(),
                &heap,
