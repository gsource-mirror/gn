...
::std::uint8_t *cxxbridge1$196$SetValueList(::Value &val, ::ParseNode const *origin, ::std::size_t size) noexcept {
  ::std::uint8_t *(*SetValueList$)(::Value &, ::ParseNode const *, ::std::size_t) = ::SetValueList;
